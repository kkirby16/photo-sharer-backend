...
Post.create(user_id: 3, caption: "Check this out!", seeded_image_data: "react-project-backend/public/assets/pexels-eberhard-grossgasteiger-1366919 (1).jpg")
Post.create(user_id: 4, caption: "Look at this!", seeded_image_data: "react-project-backend/public/assets/pexels-lukas-schulz-6113860.jpg")
Post.create(user_id: 2, caption: "Love this capture I got!", seeded_image_data: "react-project-backend/public/assets/pexels-thomas-vitali-3486711.jpg")
Post.create(user_id: 3, caption: "Loved how this shot turned out!", seeded_image_data: "react-project-backend/public/assets/pexels-leo-enrique-paredes-lopez-17324478.jpg")
Post.create(user_id: 1, caption: "One of my favorite places!", seeded_image_data: "react-project-backend/public/assets/pexels-baptiste-valthier-803217.jpg")
